...
panel_cleanup_do (void)
{
 ...
 for (l = cleaner; l; l = l->next) {
  ...
  do { if (1) g_slice_free1 (sizeof (PanelClean), (clean)); else (void) ((PanelClean*) 0 == (clean)); } while (0);
 }
   ...
   gpointer data)
{
 ...
 do { if ((func != ((void*)0))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "func != NULL"); return; } } while (0);

 clean = ((PanelClean*) g_slice_alloc (sizeof (PanelClean)));
 clean->func = func;
 clean->data = data;
...
panel_cleanup_unref_and_nullify (gpointer data)
{
 ...
 do { if ((data != ((void*)0))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "data != NULL"); return; } } while (0);
