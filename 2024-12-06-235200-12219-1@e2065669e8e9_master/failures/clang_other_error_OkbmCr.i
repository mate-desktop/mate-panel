# 1 "mate-panel-applet-marshal.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "mate-panel-applet-marshal.c" 2
# 1 "./mate-panel-applet-marshal.h" 1
...
# 6 "./mate-panel-applet-marshal.h" 2




extern
void mate_panel_applet_marshal_VOID__ENUM_BOXED_OBJECT (GClosure *closure,
                                                        GValue *return_value,
                                                        guint n_param_values,
                                                        const GValue *param_values,
                                                        gpointer invocation_hint,
                                                        gpointer marshal_data);
# 28 "./mate-panel-applet-marshal.h"
extern
void mate_panel_applet_marshal_BOOLEAN__STRING (GClosure *closure,
                                                GValue *return_value,
                                                guint n_param_values,
                                                const GValue *param_values,
                                                gpointer invocation_hint,
                                                gpointer marshal_data);
# 2 "mate-panel-applet-marshal.c" 2
# 52 "mate-panel-applet-marshal.c"
void
mate_panel_applet_marshal_VOID__ENUM_BOXED_OBJECT (GClosure *closure,
                                                   ...
                                                   gpointer marshal_data)
{
  typedef void (*GMarshalFunc_VOID__ENUM_BOXED_OBJECT) (gpointer data1,
                                                        gint arg1,
                                                        gpointer arg2,
                                                        gpointer arg3,
                                                        gpointer data2);
  ...
  GMarshalFunc_VOID__ENUM_BOXED_OBJECT callback;

  do { if ((n_param_values == 4)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "n_param_values == 4"); return; } } while (0);
  ...
  callback = (GMarshalFunc_VOID__ENUM_BOXED_OBJECT) (marshal_data ? marshal_data : cc->callback);
...
void
mate_panel_applet_marshal_BOOLEAN__STRING (GClosure *closure,
                                           GValue *return_value,
                                           guint n_param_values,
                                           const GValue *param_values,
                                           gpointer invocation_hint __attribute__ ((__unused__)),
                                           gpointer marshal_data)
{
  ...
  do { if ((return_value != ((void*)0))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "return_value != NULL"); return; } } while (0);
  do { if ((n_param_values == 2)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "n_param_values == 2"); return; } } while (0);
