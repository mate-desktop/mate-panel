# 1 "/rootdir/libmate-panel-applet/tmp-introspectlp03cssc/MatePanelApplet-4.0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/rootdir/libmate-panel-applet/tmp-introspectlp03cssc/MatePanelApplet-4.0.c" 2
...
# 7 "/rootdir/libmate-panel-applet/tmp-introspectlp03cssc/MatePanelApplet-4.0.c" 2
# 44 "/rootdir/libmate-panel-applet/tmp-introspectlp03cssc/MatePanelApplet-4.0.c"
...
# 45 "/rootdir/libmate-panel-applet/tmp-introspectlp03cssc/MatePanelApplet-4.0.c" 2
...
# 46 "/rootdir/libmate-panel-applet/tmp-introspectlp03cssc/MatePanelApplet-4.0.c" 2
...
# 49 "/rootdir/libmate-panel-applet/tmp-introspectlp03cssc/MatePanelApplet-4.0.c" 2
      ...
      while (parent != ((GType) ((0) << (2))))
        {
          ...
          (__builtin_constant_p (g_type_name (parent)) ? __extension__ ({ const char * const __val = (g_type_name (parent)); g_string_append_len_inline (parent_str, __val, (__val != ((void*)0)) ? (gssize) strlen (((__val) + !(__val))) : (gssize) -1); }) : g_string_append_len_inline (parent_str, g_type_name (parent), (gssize) -1));
...
# 626 "/rootdir/libmate-panel-applet/tmp-introspectlp03cssc/MatePanelApplet-4.0.c"
static gboolean
...
extern GType mate_panel_applet_get_type(void);
extern GType mate_panel_applet_orient_get_type(void);
extern GType mate_panel_applet_background_type_get_type(void);
extern GType mate_panel_applet_flags_get_type(void);
__attribute__((visibility("default"))) GType (*GI_GET_TYPE_FUNCS_[])(void) = {
  mate_panel_applet_get_type,
  mate_panel_applet_orient_get_type,
  mate_panel_applet_background_type_get_type,
  mate_panel_applet_flags_get_type
};
