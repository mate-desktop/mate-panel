...
(g_assert_finalize_object) (GObject *object)
{
  ...
  do { if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((weak_pointer)), (((GType) ((20) << (2))))))))) ; else g_assertion_message ("notification-area-applet", "/usr/include/glib-2.0/gobject/gobject.h", 804, ((const char*) (__func__)), "'" "G_IS_OBJECT (weak_pointer)" "' should be TRUE"); } while (0);
  g_object_add_weak_pointer (object, &weak_pointer);
  g_object_unref (weak_pointer);
  do { if ((weak_pointer) == ((void*)0)) ; else g_assertion_message ("notification-area-applet", "/usr/include/glib-2.0/gobject/gobject.h", 807, ((const char*) (__func__)), "'" "weak_pointer" "' should be NULL"); } while (0);
}
...
extern
void _na_marshal_VOID__OBJECT_OBJECT (GClosure *closure,
                                      GValue *return_value,
                                      guint n_param_values,
                                      const GValue *param_values,
                                      gpointer invocation_hint,
...
extern
void _na_marshal_VOID__OBJECT_STRING_LONG_LONG (GClosure *closure,
                                                GValue *return_value,
                                                guint n_param_values,
                                                const GValue *param_values,
                                                gpointer invocation_hint,
...
extern
void _na_marshal_VOID__OBJECT_LONG (GClosure *closure,
                                    GValue *return_value,
                                    guint n_param_values,
                                    const GValue *param_values,
                                    gpointer invocation_hint,
                                 ...
                                 gpointer marshal_data)
{
  ...
  do { if ((n_param_values == 3)) { } else { g_return_if_fail_warning ("notification-area-applet", ((const char*) (__func__)), "n_param_values == 3"); return; } } while (0);
                                           ...
                                           gpointer marshal_data)
{
  ...
  do { if ((n_param_values == 5)) { } else { g_return_if_fail_warning ("notification-area-applet", ((const char*) (__func__)), "n_param_values == 5"); return; } } while (0);
