# 1 "test-system-timezone.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "test-system-timezone.c" 2
# 22 "test-system-timezone.c"
...
# 23 "test-system-timezone.c" 2
# 1 "./system-timezone.h" 1
# 26 "./system-timezone.h"
...
# 27 "./system-timezone.h" 2
# 45 "./system-timezone.h"
typedef struct
{
        GObject g_object;
} SystemTimezone;
...
timezone_monitor (void)
{
 ...
 systz = system_timezone_new ();
 g_signal_connect_data ((systz), ("changed"), (((GCallback) (timezone_changed))), (((void*)0)), ((void*)0), (GConnectFlags) 0);


 mainloop = g_main_loop_new (((void*)0), (0));
      ...
      char **argv)
{
 ...
 GOptionContext *context;
        GOptionEntry options[] = {
                { "get", 'g', 0, G_OPTION_ARG_NONE, &get, "Get the current timezone", ((void*)0) },
                { "set", 's', 0, G_OPTION_ARG_STRING, &tz_set, "Set the timezone to TIMEZONE", "TIMEZONE" },
                { "monitor", 'm', 0, G_OPTION_ARG_NONE, &monitor, "Monitor timezone changes", ((void*)0) },
 ...
 if (get || (!tz_set && !monitor))
  ...
  do { g_assertion_message_expr (((gchar*) 0), "test-system-timezone.c", 117, ((const char*) (__func__)), ((void*)0)); } while (0);
