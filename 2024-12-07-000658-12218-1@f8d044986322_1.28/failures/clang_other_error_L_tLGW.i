# 1 "panel-applet-mini.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "panel-applet-mini.c" 2
...
# 4 "panel-applet-mini.c" 2
gboolean mate_panel_applet_frame_dbus_load (const gchar *iid, gpointer frame_act);
gboolean mate_panel_applet_frame_dbus_load (const gchar *iid, gpointer frame_act) { return (0); }
