# 1 "panel-typebuiltins.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "panel-typebuiltins.c" 2
...
# 5 "panel-typebuiltins.c" 2
# 1 "./panel-typebuiltins.h" 1
# 13 "./panel-typebuiltins.h"
...
GType panel_gsettings_key_type_get_type (void);



GType panel_speed_get_type (void);
# 6 "panel-typebuiltins.c" 2


# 1 "./../mate-panel/panel-enums-gsettings.h" 1
# 34 "./../mate-panel/panel-enums-gsettings.h"
typedef enum {
...
# 1 "./../mate-panel/panel-enums.h" 1
# 37 "./../mate-panel/panel-enums.h"
typedef enum {
 PANEL_EDGE_NONE = 0,
 PANEL_EDGE_TOP = 1 << 0,
...
static const GEnumValue _panel_gsettings_key_type_values[] = {
  { PANEL_GSETTINGS_TOPLEVELS, "PANEL_GSETTINGS_TOPLEVELS", "toplevels" },
  { PANEL_GSETTINGS_OBJECTS, "PANEL_GSETTINGS_OBJECTS", "objects" },
  { 0, ((void*)0), ((void*)0) }
};

GType
panel_gsettings_key_type_get_type (void)
{
  static GType type = 0;

  if (!type)
    type = g_enum_register_static ("PanelGSettingsKeyType", _panel_gsettings_key_type_values);

  return type;
}


# 1 "./../mate-panel/panel-types.h" 1
