...
{
 if (!list) {
  do { if ((sibling == ((void*)0))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "sibling == NULL"); return (list); } } while (0);
  return link;
 } else if (sibling) {
  if (sibling->prev) {
   ...
   link->next = sibling;
   sibling->prev = link;
   do { if ((sibling == list)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "sibling == list"); return (link); } } while (0);
   return link;
  }
 } else {
  GList *last;
...
{
 if (!list) {
  do { if ((sibling == ((void*)0))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "sibling == NULL"); return (link); } } while (0);
  return link;
 } else if (sibling) {
  if (sibling->next) {
     ...
     GCompareFunc func)
{
 ...
 do { if ((func != ((void*)0))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "func != NULL"); return (list); } } while (0);
      ...
      gboolean free_data)
{
 ...
 do { if ((compare != ((void*)0))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "compare != NULL"); return (list); } } while (0);
